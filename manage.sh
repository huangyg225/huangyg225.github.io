...
# 部署网站
deploy_website() {
    echo -e "${BLUE}🚀 开始部署Guang网站到GitHub Pages...${NC}"
    ...
    # 提交更改
    echo -e "${CYAN}💾 提交更改...${NC}"
    git commit -m "Update Guang website - $(date '+%Y-%m-%d %H:%M:%S')"
    ...
    echo "5. 保存设置"
    echo ""
    echo -e "${CYAN}🌍 网站将在几分钟后可通过 https://你的用户名.github.io/Guang-X.github.io 访问${NC}"
}
